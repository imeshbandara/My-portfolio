  ...
  return (
    <section id="contact" className="py-24">
      <div className="max-w-6xl mx-auto px-4 md:px-12 text-center">
        <h2 className="text-cyan-400 font-mono mb-4">03. What's Next?</h2>
        ...
        <div className="mt-16 flex justify-center gap-8 text-slate-400">
          <a href="https://github.com/yourusername" className="hover:text-cyan-400 transition">GitHub</a>
          <a href="https://linkedin.com/in/yourusername" className="hover:text-cyan-400 transition">LinkedIn</a>
        </div>
      </div>
    </section>
  );
